import os
from plantclef.config import get_model_dir


def setup_fine_tuned_model(use_only_classifier: bool = False):
    """
    ...
    """
    model_base_path = get_model_dir()  # get directory for model
