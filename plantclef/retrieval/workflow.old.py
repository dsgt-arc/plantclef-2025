...
from plantclef.retrieval.embed.index_setup import setup_index
...
class ProcessInference(luigi.Task):
    ...
    num_partitions = luigi.OptionalIntParameter(default=1)
    ...
    index_path = luigi.Parameter(default=setup_index(scratch_model=True))
    index_name = luigi.Parameter(default="train_embeddings")
...
def main(
    ...
    num_partitions: Annotated[int, typer.Option(help="Number of partitions")] = 1,
